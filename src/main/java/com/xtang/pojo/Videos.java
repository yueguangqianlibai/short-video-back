...
public class Videos {
    ...
    public Videos(String id, String userId, String audioId, String videoDesc, String videoPath, Float videoSeconds, Integer videoWidth, Integer videoHeigh, String coverPath, Long likeCounts, Integer status, Date createTime) {
        this.id = id;
        this.userId = userId;
